...
// Main Customer Churn Prediction App
const CustomerChurnApp: React.FC = () => {
  const [prediction, setPrediction] = useState<{ churn: boolean; probability: number } | null>(null);
  ...
  return (
    <div className="min-h-screen p-4 md:p-8">
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="relative overflow-hidden rounded-2xl p-8 text-center space-y-4">
          ...
          <div className="relative z-10">
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <h1 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-blue-500 via-purple-500 via-pink-500 to-violet-500 bg-clip-text text-transparent tracking-wide">
            ...
            <div className="mt-6 animate-fade-in">
              <img 
                ...
                alt="Telecom customers" 
                className="mx-auto rounded-xl shadow-card hover:scale-105 transition-smooth w-full h-28 object-cover object-center"
              />
            </div>
          </div>
        </div>
        ...
        {/* Result Card */}
        {prediction && (
          <PredictionResult churn={prediction.churn} probability={prediction.probability} />
        )}
...
export default CustomerChurnApp;